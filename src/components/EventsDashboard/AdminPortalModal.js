          ...
          <div className="flex-1 pl-6 overflow-y-auto">
            <div className="h-full">
              ...
              <div className="mb-6 p-4 bg-purple-50 rounded-lg border border-purple-200">
                <h4 className="font-semibold text-purple-800 mb-2">🔍 Difference Detector</h4>
                <p className="text-sm text-purple-600 mb-3">Paste gym text to detect title/date/time changes</p>
                <button
